...
from ultralytics.nn.modules.base_layer import PBSA, WCS_M, EPM, LPM

# AMSP_UOD
# from ultralytics.nn.modules.AMSP_UOD import SC, C2fAMSP, PWConv
...
class BaseModel(nn.Module):
    ...
    def _predict_once(self, x, profile=False, visualize=False, embed=None):
        ...
        for m in self.model:
            ...
            if visualize:
                feature_visualization_all(x, m.type, m.i, save_dir=visualize)
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in {
        ...
        elif m in {Detect, WorldDetect, Segment, Pose, OBB, ImagePoolingAttn, v10Detect, LPM}:
            ...
            args.append([ch[x] for x in f])
            c2 = ch[f[1]]
        # elif m is LittleAttn:
        #     c1 = [ch[x] for x in f]
        #     c2 = ch[f[1]]
        #     args = [c1]
        elif m is VitBackbone:
            c2 = 768
        elif m is split_scale:
            c2 = 768
        else:
            c2 = ch[f]
